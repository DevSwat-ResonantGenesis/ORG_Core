...
http {
    ...
    server {
        listen 80;
        server_name resonant.dev-swat.com;
    ...
    server {
        ...
        # SSL Configuration
        ssl_certificate /etc/letsencrypt/live/resonant.dev-swat.com/fullchain.pem;
        ssl_certificate_key /etc/letsencrypt/live/resonant.dev-swat.com/privkey.pem;
